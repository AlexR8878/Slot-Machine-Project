...
void testCalculateWinnings() {
    ...
    double winningsOneLine = calculateWinnings(1, 10.0, spinResultsOneLine);
    ...
    double winningsTwoLines = calculateWinnings(2, 10.0, spinResultsTwoLines);
    ...
    double winningsThreeLines = calculateWinnings(3, 10.0, spinResultsThreeLines);
    ...
    double winningsXMatch = calculateWinnings(3, 10.0, spinResultsXMatch);
    ...
    double winningsNoMatchNoX = calculateWinnings(3, 10.0, spinResultsNoMatchNoX);
    ...
    double winningsMinBetEdge = calculateWinnings(1, 0.01, spinResultsMinBetEdge);
    ...
    double winningsOneLineX = calculateWinnings(1, 10.0, spinResultsOneLineX);
    ...
    double winningsTwoLinesX = calculateWinnings(2, 10.0, spinResultsTwoLinesX);
    ...
    double winningsOneLineNoMatchX = calculateWinnings(1, 10.0, spinResultsOneLineNoMatchX);
    ...
    double winningsTwoLinesNoMatchX = calculateWinnings(2, 10.0, spinResultsTwoLinesNoMatchX);
    ...
    double winningsOneLineTop = calculateWinnings(1, 10.0, spinResultsOneLineTop);
    ...
    double winningsOneLineBottom = calculateWinnings(1, 10.0, spinResultsOneLineBottom);
    ...
    double winningsTwoLinesBottom = calculateWinnings(2, 10.0, spinResultsTwoLinesBottom);
    ...
    double winningsTwoLinesTop = calculateWinnings(2, 10.0, spinResultsTwoLinesTop);
    ...
    double winningsThreeLinesXTop = calculateWinnings(3, 10.0, spinResultsThreeLinesXTop);
